...
class CourtSchedulerNomisApiService(
  ...
  suspend fun upsertCourtScheduleOut(prisonerNumber: String, request: UpsertCourtScheduleOut): UpsertCourtScheduleOutResponse = scheduleApi.upsertCourtScheduleOut(prisonerNumber, request, recreate = null).awaitBodyOrLogAndRethrowBadRequest()
