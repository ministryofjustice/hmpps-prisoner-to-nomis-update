...
class TransferSchedulerNomisApiService(
  ...
  suspend fun deleteTransferScheduleOut(prisonerNumber: String, eventId: Long) = scheduleApi.prepare(scheduleApi.deleteTransferScheduleOutRequestConfig(prisonerNumber, eventId))
    .retrieve()
