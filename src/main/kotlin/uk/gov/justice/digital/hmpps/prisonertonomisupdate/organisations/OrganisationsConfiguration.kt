...
class OrganisationsConfiguration(
  ...
  class PersonRelationshipsApiHealth(@Qualifier("organisationsApiHealthWebClient") webClient: WebClient) : ReactiveHealthPingCheck(webClient)
}
