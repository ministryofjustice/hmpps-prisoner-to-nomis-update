...
class ContactPersonMappingApiService(@Qualifier("mappingWebClient") val webClient: WebClient) {
  ...
  suspend fun createPersonMapping(mappings: PersonMappingDto) = webClient.post()
  ...
  suspend fun createContactMapping(mappings: PersonContactMappingDto) = webClient.post()
  ...
  suspend fun createAddressMapping(mappings: PersonAddressMappingDto) = webClient.post()
  ...
  suspend fun createEmailMapping(mappings: PersonEmailMappingDto) = webClient.post()
    .uri("/mapping/contact-person/email")
    .bodyValue(mappings)
    .retrieve()
    .awaitBodilessEntityOrThrowOnConflict()

  suspend fun createPhoneMapping(mappings: PersonPhoneMappingDto) = webClient.post()
  ...
  suspend fun createContactRestrictionMapping(mappings: PersonContactRestrictionMappingDto) = webClient.post()
    .uri("/mapping/contact-person/contact-restriction")
    .bodyValue(mappings)
    .retrieve()
    .awaitBodilessEntityOrThrowOnConflict()

  suspend fun createPersonRestrictionMapping(mappings: PersonRestrictionMappingDto) = webClient.post()
