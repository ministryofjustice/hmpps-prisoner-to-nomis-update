...
class TransferSchedulerMappingApiService(@Qualifier("mappingWebClient") webClient: WebClient) {
  ...
  suspend fun createTransferScheduleMapping(mapping: TransferScheduleMappingDto) = scheduleApi.createTransferScheduleMapping(mapping).awaitBodilessEntityOrThrowOnConflict()
