  ...
  inner class RepairCSIPReport {
    ...
    inner class HappyPath {
      ...
      inner class Repair {
        ...
        @Test
        fun `will not call the mapping service to delete child mappings`() {
          csipMappingApi.verify(exactly(0), deleteRequestedFor(urlMatching("/mapping/csip/dps-csip-id/$dpsCSIPReportId/children")))
        }
            ...
            postRequestedFor(urlPathEqualTo("/mapping/csip/children/all"))
              ...
              .withRequestBody(
                matchingJsonPath(
                  ...
                  equalTo("8cdadcf3-b003-4116-9956-c99bd8df6111"),
                ),
              )
              ...
              .withRequestBody(
                matchingJsonPath(
                  "planMappings[0].dpsId",
                  equalTo("8cdadcf3-b003-4116-9956-c99bd8df6333"),
                ),
              )
      ...
      @Nested
      inner class RepairWithClearedChildMappings {
        @BeforeEach
        fun setUp() {
        ...
        @Test
        fun `will call the mapping service to delete child mappings`() {
          csipMappingApi.verify(deleteRequestedFor(urlMatching("/mapping/csip/dps-csip-id/$dpsCSIPReportId/children")))
        }
