  ...
  inner class GetPrisonTransaction {
    ...
    fun `will return the prison (GL) transactions`() = runTest {
      ...
      with(prisonTransactions.first()) {
        ...
        assertThat(transactionTimestamp).isEqualTo(LocalDateTime.parse("2024-06-18T14:30:12"))
        assertThat(reference).isEqualTo("ref 123")
        assertThat(createdAt).isEqualTo(LocalDateTime.parse("2024-06-18T14:30:12.364617"))
        assertThat(createdBy).isEqualTo("J_BROWN")
        assertThat(createdByDisplayName).isEqualTo("Jim Brown")
        assertThat(lastModifiedAt).isEqualTo(LocalDateTime.parse("2025-02-03T04:05:59.364617"))
