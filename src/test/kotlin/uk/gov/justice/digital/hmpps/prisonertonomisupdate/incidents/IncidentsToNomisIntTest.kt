          ...
          fun `the created incident will contain details of the responses`() {
            nomisApi.verify(
              putRequestedFor(anyUrl())
                ...
                .withRequestBodyJsonPath("questions[0].responses[0].response", "Yes")
                ...
                .withRequestBodyJsonPath("questions[1].responses[0].response", "No")
                ...
                .withRequestBodyJsonPath("questions[1].responses[1].response", "Bob")
