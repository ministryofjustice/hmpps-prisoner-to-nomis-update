            ...
            """
{
  ...
  fun stubCourtAppearanceUpdate(offenderNo: String, courtCaseId: Long, courtAppearanceId: Long, response: String) {
    stubFor(
      put("/prisoners/$offenderNo/sentencing/court-cases/$courtCaseId/court-appearances/$courtAppearanceId").willReturn(
        aResponse()
          .withHeader("Content-Type", "application/json")
          .withBody(response)
          .withStatus(201),
  ...
  fun stubCourtChargeCreate(offenderNo: String, courtCaseId: Long, response: String) {
    stubFor(
      post("/prisoners/$offenderNo/sentencing/court-cases/$courtCaseId/charges").willReturn(
        aResponse()
          .withHeader("Content-Type", "application/json")
          .withBody(response)
          .withStatus(201),
  ...
  fun stubCourtChargeUpdate(offenderChargeId: Long, courtAppearanceId: Long, offenderNo: String, courtCaseId: Long) {
    stubFor(
      put("/prisoners/$offenderNo/sentencing/court-cases/$courtCaseId/court-appearances/$courtAppearanceId/charges/$offenderChargeId").willReturn(
        aResponse()
          .withHeader("Content-Type", "application/json")
          .withStatus(200),
      ),
  ...
  fun stubSentenceCreate(offenderNo: String, caseId: Long, response: String) {
    stubFor(
      post("/prisoners/$offenderNo/court-cases/$caseId/sentences").willReturn(
        aResponse()
          .withHeader("Content-Type", "application/json")
          .withBody(response)
          .withStatus(201),
  ...
  fun stubSentenceUpdate(offenderNo: String, caseId: Long, sentenceSeq: Long) {
    stubFor(
      put("/prisoners/$offenderNo/court-cases/$caseId/sentences/$sentenceSeq").willReturn(
        aResponse()
          .withHeader("Content-Type", "application/json")
          .withStatus(201),
      ),
